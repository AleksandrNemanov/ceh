...
################################################################################
## Form generated from reading UI file 'ui_branch.ui'
##
...
class Ui_Branch(object):
    def setupUi(self, Branch):
        ...
        Branch.resize(598, 284)
        icon = QIcon()
        icon.addFile(u"icons/Git.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        Branch.setWindowIcon(icon)
        self.gridLayout = QGridLayout(Branch)
        self.gridLayout.setObjectName(u"gridLayout")
        self.chbx_wrap = QCheckBox(Branch)
        self.chbx_wrap.setObjectName(u"chbx_wrap")

        self.gridLayout.addWidget(self.chbx_wrap, 0, 0, 1, 1)

        self.txt_input_field = QPlainTextEdit(Branch)
...
"")
    ...
    def retranslateUi(self, Branch):
        Branch.setWindowTitle(QCoreApplication.translate("Branch", u"Branches", None))
        self.chbx_wrap.setText(QCoreApplication.translate("Branch", u"Wrap", None))
        self.txt_input_field.setPlainText("")
        self.txt_input_field.setPlaceholderText(QCoreApplication.translate("Branch", u"\u0417\u0434\u0435\u0441\u044c \u043c\u043e\u0436\u043d\u043e \u0445\u0440\u0430\u043d\u0438\u0442\u044c \u043d\u0430\u0438\u043c\u0435\u043d\u043e\u0432\u0430\u043d\u0438\u044f \u0432\u0435\u0442\u043e\u043a, \u0441 \u043a\u043e\u0442\u043e\u0440\u044b\u043c\u0438 \u0440\u0430\u0431\u043e\u0442\u0430\u043b\u0438. \u0421\u043e\u0445\u0440\u0430\u043d\u044f\u0435\u0442\u0441\u044f \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438", None))
    # retranslateUi
