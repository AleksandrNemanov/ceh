...
################################################################################
## Form generated from reading UI file 'ui_rdv_requests.ui'
##
...
class Ui_RdvRequests(object):
    def setupUi(self, RdvRequests):
        if not RdvRequests.objectName():
            RdvRequests.setObjectName(u"RdvRequests")
        RdvRequests.resize(598, 239)
        icon = QIcon()
        icon.addFile(u"icons/rdv_ingo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        RdvRequests.setWindowIcon(icon)
        self.gridLayout = QGridLayout(RdvRequests)
        self.gridLayout.setObjectName(u"gridLayout")
        self.chbx_wrap = QCheckBox(RdvRequests)
        self.chbx_wrap.setObjectName(u"chbx_wrap")

        self.gridLayout.addWidget(self.chbx_wrap, 0, 0, 1, 1)

        self.txt_input_field = QPlainTextEdit(RdvRequests)
...
"")
        ...
        self.retranslateUi(RdvRequests)

        QMetaObject.connectSlotsByName(RdvRequests)
    # setupUi

    def retranslateUi(self, RdvRequests):
        RdvRequests.setWindowTitle(QCoreApplication.translate("RdvRequests", u"RDV requests", None))
        self.chbx_wrap.setText(QCoreApplication.translate("RdvRequests", u"Wrap", None))
        self.txt_input_field.setPlainText("")
        self.txt_input_field.setPlaceholderText(QCoreApplication.translate("RdvRequests", u"\u0425\u0440\u0430\u043d\u0438\u0442\u044c \u043c\u043e\u0436\u043d\u043e \u0437\u0434\u0435\u0441\u044c \u043f\u0440\u0435\u0434\u044b\u0434\u0443\u0449\u0438\u0435 \u0437\u0430\u043f\u0443\u0441\u043a\u0438 \u0438 \u0442\u0434", None))
    # retranslateUi
