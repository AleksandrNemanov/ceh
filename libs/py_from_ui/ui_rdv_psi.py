...
################################################################################
## Form generated from reading UI file 'ui_rdv_psi.ui'
##
...
class Ui_RdvPsi(object):
    def setupUi(self, RdvPsi):
        if not RdvPsi.objectName():
            RdvPsi.setObjectName(u"RdvPsi")
        RdvPsi.resize(554, 238)
        icon = QIcon()
        icon.addFile(u"icons/rdv_psi.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        RdvPsi.setWindowIcon(icon)
        self.gridLayout = QGridLayout(RdvPsi)
        self.gridLayout.setObjectName(u"gridLayout")
        self.chbx_wrap = QCheckBox(RdvPsi)
        self.chbx_wrap.setObjectName(u"chbx_wrap")

        self.gridLayout.addWidget(self.chbx_wrap, 0, 0, 1, 1)

        self.txt_input_field = QPlainTextEdit(RdvPsi)
...
"")
        ...
        self.retranslateUi(RdvPsi)

        QMetaObject.connectSlotsByName(RdvPsi)
    # setupUi

    def retranslateUi(self, RdvPsi):
        RdvPsi.setWindowTitle(QCoreApplication.translate("RdvPsi", u"RDV PSI", None))
        self.chbx_wrap.setText(QCoreApplication.translate("RdvPsi", u"Wrap", None))
        self.txt_input_field.setPlainText("")
        self.txt_input_field.setPlaceholderText(QCoreApplication.translate("RdvPsi", u"\u0427\u0442\u043e \u043d\u0435\u043e\u0431\u0445\u043e\u0434\u0438\u043c\u043e \u0432\u044b\u043f\u043e\u043b\u043d\u0438\u0442\u044c \u0434\u043b\u044f \u043f\u0440\u043e\u0445\u043e\u0436\u0434\u0435\u043d\u0438\u0435 \u041f\u0421\u0418", None))
    # retranslateUi
