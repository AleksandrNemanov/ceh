...
################################################################################
## Form generated from reading UI file 'ui_rdv_instruction.ui'
##
...
class Ui_RdvInstruction(object):
    def setupUi(self, RdvInstruction):
        if not RdvInstruction.objectName():
            RdvInstruction.setObjectName(u"RdvInstruction")
        RdvInstruction.resize(598, 239)
        icon = QIcon()
        icon.addFile(u"icons/instruction.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        RdvInstruction.setWindowIcon(icon)
        self.gridLayout = QGridLayout(RdvInstruction)
        self.gridLayout.setObjectName(u"gridLayout")
        self.chbx_wrap = QCheckBox(RdvInstruction)
        self.chbx_wrap.setObjectName(u"chbx_wrap")

        self.gridLayout.addWidget(self.chbx_wrap, 0, 0, 1, 1)

        self.txt_input_field = QPlainTextEdit(RdvInstruction)
...
"")
        ...
        self.retranslateUi(RdvInstruction)

        QMetaObject.connectSlotsByName(RdvInstruction)
    # setupUi

    def retranslateUi(self, RdvInstruction):
        RdvInstruction.setWindowTitle(QCoreApplication.translate("RdvInstruction", u"RDV Instruction", None))
        self.chbx_wrap.setText(QCoreApplication.translate("RdvInstruction", u"Wrap", None))
        self.txt_input_field.setPlainText("")
        self.txt_input_field.setPlaceholderText(QCoreApplication.translate("RdvInstruction", u"\u0421\u043e\u0445\u0440\u0430\u043d\u044f\u0435\u043c \u0432\u0441\u0435 \u0438\u043d\u0441\u0442\u0440\u0443\u043a\u0446\u0438\u0438", None))
    # retranslateUi
